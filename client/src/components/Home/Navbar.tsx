...
const Navbar = (props: Props) => {
  return (
    <div className="flex justify-between gap-3 items-center p-4 px-16">
      ...
      <section id="search"><span className="flex rounded-full gap-2 bg-white text-black p-4 py-2 w-[440px]"><SearchIcon/><input type="text" placeholder="search products" className="bg-transparent border-none outline-none focus:border-none focus:outline-none w-full"/></span></section>
