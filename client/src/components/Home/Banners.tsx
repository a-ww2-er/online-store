...
const Banners = (props: Props) => {
  return (
    ...
    <div className="bg-gray-800 py-24 flex flex-col justify-center my-12 items-center">
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-5 gap-x-4 items-center">
          <section className="col-span-2"><h2 className=" text-center text-[2rem] font-extralight ">We cover a variety of brands and products</h2></section>
